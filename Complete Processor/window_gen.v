...
module window_gen(
    output reg [9*8-1:0] window,//a 3x3 window of unsigned 8-bit values
    ...
    input wire [8*16-1:0] row_a_reg,//an array of 16 8-bit unsigned values
    input wire [8*16-1:0] row_b_reg,//an array of 16 8-bit unsigned values
    input wire [8*16-1:0] row_c_reg,//an array of 16 8-bit unsigned values
